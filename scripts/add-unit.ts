...
const unit = new Unit({
  ...
  itemSlots: 0,
  spellSlots: ['土', '無'],
  image: 'https://firebasestorage.googleapis.com/v0/b/pedometer-eb-staging.appspot.com/o/units%2Fmon_028.png?alt=media&token=56d1da43-8746-486a-9cee-11153f276bc4',
  isLot: true,
  rarity: 'rare',
